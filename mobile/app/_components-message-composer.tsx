...
export function ConversationMessageComposer({ value, onChangeText, placeholder, leftAction, onSend, sendDisabled, rightActions, authorPicker }: {
  value: string;
  ...
  return <View>{authorPicker}<View style={styles.sceneComposer}>
    ...
    <TextInput value={value} onChangeText={onChangeText} placeholder={placeholder} placeholderTextColor={colors.dim} multiline maxLength={8000} textAlignVertical="center" style={styles.sceneComposerInput} />
